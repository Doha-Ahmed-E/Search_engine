...
public class UrlNormalizer
{
    public static String normalize(String url)
    {
        try
        {
            ...
            URI uri = new URI(u.getProtocol(), u.getUserInfo(), u.getHost(), port, u.getPath(),
                    u.getQuery(), null);
    ...
    public static String extractDomain(String url)
    {
        try
        {
            ...
            // Strip 'www.' if present for consistent domain identification
        ...
        {
            System.err.println("Domain extraction failed for: " + url);
            return null;
        }
    }
}
