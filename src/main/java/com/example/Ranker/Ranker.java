...
public class Ranker {
    ...
    private double computeRelevanceScore(QueryInput input, Document doc) {
        double score = 0.0;
    ...
    public static void main(String[] args) throws Exception {
        ...
        QueryInput input = mapper.readValue(
                new File("src/main/resources/query_results.json"), 
                QueryInput.class);
        ...
        results.forEach(doc -> System.out.printf(
                "%s: score=%.3f (relevance=%.3f, popularity=%.1f)%n",
